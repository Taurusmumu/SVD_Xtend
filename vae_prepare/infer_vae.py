...
if __name__ == "__main__":
    device = "cuda:0"
    model_weight_path = "/ssd2/AMC_zstack_2_patches/vae_1017/VAETrainer/checkpoint_35000/pytorch_model.bin"
    model = AutoencoderKLTemporalDecoder.from_pretrained(
        "stabilityai/stable-video-diffusion-img2vid",
        subfolder="vae", revision=None, variant="fp16")

    train_dataset = AMCDataset(data_dir='/ssd2/AMC_zstack_2_patches_warp/pngs_mid/',
                               split="train",
                               )
    ...
    for i, batch in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            save_orig_and_generated_gifs(original_images=pixel_values.detach()[msk],
                                         ...
                                         path_to_save_folder="/ssd2/AMC_zstack_2_patches/vae_1017/gen",
                                         step=i)
        if i == 5:
            break
